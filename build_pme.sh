...
# Path to build your kernel
  k=${HOME}/Builds/kernel/HTC/kernel
# Directory for the any kernel updater
  t=${HOME}/Builds/kernel/HTC10-AnyKernel-HOLD
# Date to add to zip
  today=$(date +"%m_%d_%Y")
...
TOOLCHAIN=${HOME}/Builds/kernel/toolchains/LinaroTC/aarch64-linux-android-6.1-kernel/bin/aarch64-linux-android-
export ARCH=arm64
...
make ARCH=arm64 CROSS_COMPILE=$TOOLCHAIN O=out htc10_defconfig
